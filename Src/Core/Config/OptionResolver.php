 ...
 * @create date 2018-04-15 19:49:27
 * @modify date 2018-04-16 04:26:15
 * @desc [description]
 */
...
class OptionResolver implements \ArrayAccess, \Countable
{
    ...
    public function setDefault($option, $value)
    {
        ...
        if ($value instanceof \Closure) {
            ...
            if (isset($params[0]) && null !== ($class = $params[0]->getClass()) && OptionsResolver::class === $class->name) {
     ...
     * @return OptionsResolver This instance
     */
    public function setDefaults(array $defaults, $clear = true)
    {
        if ($clear) $this->clear();
